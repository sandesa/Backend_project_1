		...
		public static async Task InitializeAsync(AppDbContext context)
		{
			if (!context.Products.Any())
			{
				var products = new List<Product>
				{
					...
					new Product
					{
						Name = "Klassiskt jeansskärp",
						ImageName = "jeansskärp.jpg",
						Price = 99m,
						Category = "Kläder",
						Description = "Ett stilrent och hållbart jeansskärp i klassisk design som kompletterar din outfit på ett elegant sätt."
					},
					new Product
					{
